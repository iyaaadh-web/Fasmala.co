...
export const Navigation = () => {
    ...
    const navClass = scrolled
        ...
        : "fixed top-0 w-full bg-slate-900/50 backdrop-blur-sm md:bg-slate-900 md:backdrop-blur-none py-3 px-3 z-50 transition-all duration-350 border-b border-slate-800/50 md:border-slate-800";
